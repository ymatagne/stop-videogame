		...
		<div class="container" >
			...
			<div class="row ">
				<div class="col-md-6 col-sm-12 wl_rtl">					
					...
					{ ?>
					<img class="img-responsive" src="<?php echo esc_url($wl_theme_options['upload_image_logo']); ?>" style="height:<?php if($wl_theme_options['height']!='') { echo esc_attr($wl_theme_options['height']); }  else { "80"; } ?>px; width:<?php if($wl_theme_options['width']!='') { echo esc_attr($wl_theme_options['width']); }  else { "200"; } ?>px;" />
					<?php } else { ?> 
					<?php _e('Inferno','weblizar');?>
					<?php } ?>
					</a>
				...
				<ul class="head-contact-info">
						...
						<?php if($wl_theme_options['phone_no'] !='') { ?><li><i class="fa fa-phone"></i><a href="tel:<?php echo esc_attr($wl_theme_options['phone_no']); ?>"><?php echo esc_attr($wl_theme_options['phone_no']); ?></li></a><?php } ?>
				</ul>
				<?php } ?>
					<ul class="social">
