...
<div class="enigma_footer_widget_area">	
	<div class="container">
		<div class="row">
			...
			'after_title'   => '<div id="" class="enigma-footer-separator"></div></div>' );
...
<a href="#" title="<?php _e('Go Top','weblizar'); ?>" class="enigma_scrollup" style="display: inline;"><i class="fa fa-chevron-up"></i></a>
